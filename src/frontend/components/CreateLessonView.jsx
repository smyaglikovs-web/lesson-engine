...
export const CreateLessonView = ({ initialLesson, onSaveLesson, onCancel }) => {
  ...
  const handleGenerateFullAiLesson = async () => {
    ...
    try {
      ...
      if (data.success && data.jsonText) {
        ...
        // Normalize pages structure to prevent blank screens
  ...
  return (
    <div className="space-y-6 max-w-6xl mx-auto">
      ...
      {successBanner && (
        <div className="bg-emerald-600 text-white p-4 rounded-2xl shadow-lg flex justify-between items-center font-bold text-sm animate-fade-in">
