...
import { StudentRowSkeleton } from './ui/Skeleton.jsx';
        ...
        {loading ? (
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-slate-50 border-b border-slate-100 text-[11px] font-extrabold text-slate-500 uppercase">
                  <th className="p-4 pl-6">Ученик</th>
                  <th className="p-4">Сдано работ</th>
                  <th className="p-4">Баллы</th>
                  <th className="p-4">Точность</th>
                  <th className="p-4 pr-6">Дата</th>
                </tr>
              </thead>
